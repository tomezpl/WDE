...
wde: main.o renderer.o htmlsource.o
	...
	$(CC) -o./bin/wde ./obj/main.o ./obj/renderer.o ./obj/htmlsource.o $(GTK_DEV) $(GTK_LIB) $(x86)
	@echo Finished linking. See CC output if there are any errors.
    
main.o: ./src/main.cc
	@echo Compiling main WDE module...
	$(CC) -c -o./obj/main.o ./src/main.cc $(GTK_DEV) $(x86)
...
renderer.o: ./src/renderer.cc
	...
	$(CC) -c -o./obj/renderer.o ./src/renderer.cc $(GTK_DEV) $(x86)
...
htmlsource.o: ./src/htmlsource.cc
	...
	$(CC) -c -o./obj/htmlsource.o ./src/htmlsource.cc $(GTK_DEV) $(x86)
